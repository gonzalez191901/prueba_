...
CREATE TABLE `articulos` (
  `id` int(11) NOT NULL,
  `articulo_desc` varchar(255) NOT NULL,
...
INSERT INTO `articulos` (`id`, `articulo_desc`, `price`, `updated_at`, `created_at`) VALUES
(1, 'ARTICULO 1', 1.25, '2023-02-21 22:30:28', '2023-02-21 22:30:28'),
(2, 'ARTICULO 2', 2, '2023-02-21 22:31:36', '2023-02-21 22:31:36'),
(3, 'ARTICULO 3', 2.5, '2023-02-21 22:31:56', '2023-02-21 22:31:56');
...
CREATE TABLE `orders` (
  `id` int(11) NOT NULL,
  `numero_orden` varchar(11) NOT NULL,
...
(3, 'Oscar', 'Gonzalez', 'gonzalez191901@gmail.com', NULL, '$2y$10$wldUHgB5PSLeG7KNftlzO.zOZvmbfcdD6.DLnLw4KDFovgjFddVzm', NULL, '2023-02-22 00:55:26', '2023-02-22 00:55:26');
